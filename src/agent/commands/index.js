...
import { excludedCommands, excludeCommands } from './actions.js';
...
export function getCommandDocs() {
    ...
    let filteredCommands = excludeCommands ? commandList.filter(command => {
        // Exclude specific commands based on list
        return !excludedCommands.includes(command.name);
    }) : commandList;
